...
public class dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        assignTable234 = new javax.swing.JTable();
        ...
        viewTableSales = new javax.swing.JButton();
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/myShare/myShare.icons/set_app_189.png"))); // NOI18N
        ...
        assignTable234.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jScrollPane5.setViewportView(assignTable234);
        ...
        jLabel53.setFont(new java.awt.Font("Sitka Display", 1, 24)); // NOI18N
        jLabel53.setText("Monthly Reported Sales");
        ...
        jTableSalesReport.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order ID", "Order Price", "Delivery Date"
            }
        ));
        jScrollPane12.setViewportView(jTableSalesReport);

        viewTableSales.setText("View Table");
        viewTableSales.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                viewTableSalesActionPerformed(evt);
            }
        });

        jLabelTotalSales.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabelTotalSales.setText("Enter Month");

        totalSalesLabel.setForeground(new java.awt.Color(51, 255, 0));

        jLabelTotalSales1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabelTotalSales1.setText("Enter Year");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("1-January\n2-February\n3-March\n4-April\n5-May\n6-June\n7-July\n8-August");
                    ...
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(viewTableSales)
                                .addComponent(jMonth)
                                .addComponent(jYear, javax.swing.GroupLayout.DEFAULT_SIZE, 171, Short.MAX_VALUE))
                            .addComponent(jLabelTotalSales, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabelTotalSales1, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(jLabel53, javax.swing.GroupLayout.PREFERRED_SIZE, 406, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel10Layout.createSequentialGroup()
    ...
    try {
        ...
        // Create a DefaultTableModel to hold the data
        DefaultTableModel model = (DefaultTableModel) assignTable234.getModel();
        model.setRowCount(0); // Clear the existing table data
...
//diluksha
    ...
    private void sendEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendEmailActionPerformed
     String email = txtEmail.getText().trim(); // Assuming you have a JTextField called txtEmail
    ...
    if (email.isEmpty()) {
        ...
        // Email field contains an invalid email address, show an error message
        JOptionPane.showMessageDialog(this, "Please enter a valid email address.", "Error", JOptionPane.ERROR_MESSAGE);
    } else {
        // Email field is not empty and follows a valid email format, proceed with sending the email
...
//to check if email follows format
...
//Kavinesh - monthly reported sales
    private void viewTableSalesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewTableSalesActionPerformed
        // TODO add your handling code here:
        
    String yearText = jYear.getText();
    String monthText = jMonth.getText();
    ...
    try {
        ...
        JOptionPane.showMessageDialog(this, "Invalid input for year or month.", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    try {
        ...
        // Create the SQL query to retrieve sales data for the specified year and month
        String sqlQuery = "SELECT order_id, order_cost, delivery_date FROM orders WHERE YEAR(delivery_date) = ? AND MONTH(delivery_date) = ?";
        ...
        model.setColumnIdentifiers(new Object[]{"Order ID", "Order Price", "Delivery Date"});
        ...
        while (resultSet.next()) {
            int orderID = resultSet.getInt("order_id");
            double orderPrice = resultSet.getDouble("order_cost");
            Date deliveryDate = resultSet.getDate("delivery_date");

            // Add the data as a new row to the table
            model.addRow(new Object[]{orderID, orderPrice, deliveryDate});
            
            totalSales += orderPrice;
        }

        // Display the table or the retrieved data in any desired format
        // (For example, if you have a jTableSalesReport, you can set the model to display the data)
        jTableSalesReport.setModel(model);
        
        totalSalesLabel.setText("Total Sales Made: $" + totalSales);
    ...
    }//GEN-LAST:event_viewTableSalesActionPerformed
    ...
    private javax.swing.JTable assignTable234;
    ...
    private javax.swing.JButton viewTableSales;
